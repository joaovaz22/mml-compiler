...
void mml::type_checker::do_function_defs_node(mml::function_defs_node * const node, int lvl) {
}
...
void mml::type_checker::do_var_declaration_node(mml::var_declaration_node * const node, int lvl) {
}
