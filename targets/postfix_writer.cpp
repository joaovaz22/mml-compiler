...
void mml::postfix_writer::do_function_defs_node(mml::function_defs_node * const node, int lvl) {
}
...
void mml::postfix_writer::do_var_declaration_node(mml::var_declaration_node * const node, int lvl) {
}
